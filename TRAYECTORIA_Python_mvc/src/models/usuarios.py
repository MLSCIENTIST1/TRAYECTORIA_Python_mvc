...
class Usuario(db.Model, UserMixin):
    ...
    def __init__(self, nombre, apellidos, correo, contrasenia, labor, cedula, celular, ciudad):
        ...
        self.correo = correo
        self.contrasenia = contrasenia  # Almacena directamente el hash pasado
        self.labor = labor
        self.cedula = cedula
    ...
    def set_password(self, password):
        ...
        print(f"Hash de la contraseña generada para {self.correo}: {self.contrasenia}")

    def check_password(self, password):
        result = check_password_hash(self.contrasenia, password)
        print(f"Verificación de contraseña para {self.correo}: {result}")
        return result
